# Proposta de algoritmo de binarização com janela 7x7
...
pasta_resultado = 'D:/git/projeto-binarizacao-cnn/results/janela_7/'
pasta_resultado_calibracao = 'D:/git/projeto-binarizacao-cnn/results/janela_7_calibracao/'
janela = 7
