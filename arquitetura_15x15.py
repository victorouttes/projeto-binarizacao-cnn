# Proposta de algoritmo de binarização com janela 15x15
...
pasta_resultado = 'D:/git/projeto-binarizacao-cnn/results/janela_15/'
pasta_resultado_calibracao = 'D:/git/projeto-binarizacao-cnn/results/janela_15_calibracao/'
janela = 15
...
model.add(tf.keras.layers.Dense(200, activation=tf.nn.relu, input_dim=3*3*48))
